...
class sector_classification:
    ...
    def KRX_event_code_crawling(self):
        ...
        data2 = {'Market': [], 'code': [], 'event_name': [], 'industry(Main_Category)': [],
                 'industry(intermediate_classification)': [], 'industry(subclass)': [], 'listed_stock_issued_count': [],
                 'market_cap': []}
    ...
    def Data_merge(self):
        ...
        self.dff = self.data_df2[
            ['_id', 'Market', 'code', 'event_name', 'industry(Main_Category)', 'industry(intermediate_classification)',
             'industry(subclass)', 'listed_stock_issued_count', 'market_cap']]
    ...
    def mongoDB_insert(self):
        ...
        now = str(now)
        self.dff.to_excel(
            '/home/2digit/tmp/seibro_FICS_datafile/2Digit_FICS(seibro)_Crawlling_' + now[:4] + '_' + now[5:7] + now[
                                                                                                                8:11] + '.xlsx')
